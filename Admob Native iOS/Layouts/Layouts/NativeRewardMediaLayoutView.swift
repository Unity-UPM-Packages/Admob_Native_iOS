//
//  NativeRewardMediaLayoutView.swift
//  Admob Native iOS
//
//  Layout Reward Native Ads Media toàn màn hình.
//  Ánh xạ 1:1 chuẩn xác với Android: res/layout/native_reward_media.xml & res/layout-land/native_reward_media.xml.
//

import UIKit
import GoogleMobileAds

public final class NativeRewardMediaLayoutView: BaseNativeAdLayoutView {
    ...
    public override func setupLayout() {
        ...
        // 4. Nút Skip (▶▶ Skip) dạng Pill bo góc trái (dùng closeButton của BaseNativeAdLayoutView)
        ...
        closeButton.layer.maskedCorners = [.layerMinXMinYCorner, .layerMinXMaxYCorner] // Bo tròn cạnh trái
        ...
        // 5. Pill đếm giờ màn ngang (5s remaining...) bo góc phải (dùng countdownContainerView của BaseNativeAdLayoutView)
        ...
        countdownContainerView.layer.maskedCorners = [.layerMaxXMinYCorner, .layerMaxXMaxYCorner] // Bo tròn cạnh phải
        ...
        portraitConstraints = [
            ...
            // Nút Skip (closeButton) neo độc lập ở giữa trục dọc Top Card
            closeButton.trailingAnchor.constraint(equalTo: topCardView.trailingAnchor),
        ...
        landscapeConstraints = [
            ...
            // Nút Skip (closeButton) chạm sát mép phải (3 cạnh thẳng, 1 cạnh cong trái)
