...
OUTPUT_FRAMEWORK_NAME="admob_native_unity"
OUTPUT_DIR="./build"
XCFRAMEWORK_DIR="${OUTPUT_DIR}/${OUTPUT_FRAMEWORK_NAME}.xcframework"
...
echo "📦 [4/4] Đang tạo universal ${OUTPUT_FRAMEWORK_NAME}.xcframework..."
...
echo "👉 File được lưu tại thư mục: ${OUTPUT_DIR}/${OUTPUT_FRAMEWORK_NAME}.xcframework"
echo "=============================================================================="
